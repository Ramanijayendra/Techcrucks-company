        ...
        <div className="mt-6">
          <div className="flex flex-col justify-center gap-8 p-6 lg:flex-row py-8 ">
            ...
            <div className="lg:w-3/12 lg:text-start text-center text-gray-400 ">
              ...
              <p className="mb-5">
                Mint have pioneered memory care for patients suffering with
                issues like Alzheimers or dementia. Their techniques quickly
                became utilised across their province in Canada.
              </p>
              <p className="mb-5">
                We reworked their brand and introduced a sense of warmth and
                humanity with colourful illustrations and icons.
              </p>
              <p className="mb-5">
                The site is built using Craft CMS which allows them to keep
                content fresh and the project has been very helpful in promoting
                their approach which has now spread to the whole of Canada.
              </p>
              <ul className="mb-5">
