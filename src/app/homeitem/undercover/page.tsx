        ...
        <div className="mt-6">
          <div className="flex flex-col justify-center gap-8 p-6 lg:flex-row py-8 ">
            ...
            <div className="lg:w-3/12 lg:text-start text-center text-gray-400 ">
              ...
              <p className="mb-5">
                We have worked with Jamie the founder at London Undercover for
                around 8 years. The brand has grown from strength to strength
                and has been featured in publications around the world.{" "}
              </p>
              <p className="mb-5">
                Re-designing and moving the previous site over to Solidus we
                tried to make running the site and shop on Liverpool Street as
