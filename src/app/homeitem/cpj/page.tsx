        ...
        <div className="mt-6">
          <div className="flex flex-col justify-center gap-8 p-6 lg:flex-row py-8 ">
            ...
            <div className="lg:w-3/12 lg:text-start text-center text-gray-400 ">
              <h1 className="text-3xl font-bold mb-5 text-black">CPJ Field </h1>
              <p className="mb-5">
                CPJ Field is a family owned funeral care company with 50
                branches and a history of over 300 years
              </p>
              <p className="mb-5">
                We took their brand and created a website that features a number
                of illustrations and animations all focusing on their service
                across the last three centuries.
              </p>
              <p className="mb-5">
                The end result is a beautiful site, integrated with their
                backend software and powered by Craft CMS.
              </p>
              <ul className="mb-5">
