        ...
        <div className="mt-6">
          <div className="flex flex-col justify-center gap-8 p-6 lg:flex-row py-8 ">
            ...
            <div className="lg:w-3/12 lg:text-start text-center text-gray-400 ">
              ...
              <p className="mb-5">
                Working with the fantastic guys at Proud Creative we handled the
                front and backend development of the site. It features some
                silky Javascript, mobile integration - all wrapped up in a
                simple CMS.{" "}
              </p>
              <p className="mb-5">
                The end result is something that allows the client's fantastic
                content to shine through and provides a platform that can suport
