        ...
        <div className="mt-6">
          <div className="flex flex-col justify-center gap-8 p-6 lg:flex-row py-8 ">
            ...
            <div className="lg:w-3/12 lg:text-start text-center text-gray-400 ">
              ...
              <p className="mb-5">
                Koryo were the first company to offer tours to North Korea over
                20 years ago. Since then they have organised amazing trips for
                tens of thousands of people keen to see life in Pyongyang and
                the surrounds.
              </p>
              <p className="mb-5">
                After rebranding Koryo we designed and built a site that allows
                people to see the itineraries that are available and then apply
                to travel to the DRPK
              </p>
              <p className="mb-5">
                The site is built with Ruby on Rails and has replaced a lot of
                the unwieldy Excel files that were used to run the business.
              </p>
              <ul className="mb-5">
