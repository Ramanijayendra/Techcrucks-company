        ...
        <div className="mt-6">
          <div className="flex flex-col justify-center gap-8 p-6 lg:flex-row py-8 ">
            ...
            <div className="lg:w-3/12 lg:text-start text-center text-gray-400 ">
              <h1 className="text-3xl font-bold mb-5 text-black">DCM</h1>
              <p className="mb-5">
                DCM look after nearly 95% of the UK's cinema advertising. Having
                worked with them on their previous site we re-worked this
                version from scratch to support changes in their growing
                business.
              </p>
              <p className="mb-5">
                Built using Expression Engine the site allows DCM to keep things
                fresh without hassle and features a planner that is linked to
