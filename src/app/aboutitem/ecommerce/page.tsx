      ...
      <div className="container">
        ...
        <section>
          ...
          <div className="flex justify-center items-center gap-10 mb-10">
            <button
              type="button"
              className="bg-[#0071e2] hover:bg-[#24b4fb] text-white  py-2.5 px-8 border-b-4 border-blue-700 hover:border-blue-500 rounded"
            >
              Yes
            </button>
            <button
              type="button"
              className="bg-[#0071e2] hover:bg-[#24b4fb] text-white  py-2.5 px-10 border-b-4 border-blue-700 hover:border-blue-500 rounded"
            >
              No
            </button>
          </div>
        ...
        <section>
          ...
          <div className="flex flex-col gap-6 justify-center items-center py-8 lg:flex-row p-6 ">
            ...
            <button className="p-3 bg-[#0071e2] hover:bg-[#24b4fb] lg: w-72  rounded text-white ">
              No huge rush
            </button>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="flex flex-col gap-6 justify-center items-center  lg:flex-row p-6 ">
            <button className="p-3 bg-[#0071e2] hover:bg-[#24b4fb] w-full lg:w-40  rounded text-white">
              Under 20k
            </button>
            <button className="p-3 bg-[#0071e2] hover:bg-[#24b4fb] w-full  lg:w-40  rounded text-white">
              20 - 30K
