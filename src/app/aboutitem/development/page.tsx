              ...
              <div>
                <ul className="py-7">
                  ...
                  <li className="text-gray-400 mb-4">
                    ...
                    sites, complex business critical applications and countless
                    marketing focus websites.
                  </li>
                  <li className="text-gray-400 mb-4">
                    We have been the founding team for a number of startups that
                    have gone on to raise serious funding. We have then helped
                    those companies scale and hire their own team.
                  </li>

                  <li className="text-gray-400 mb-4">
                    Most of all we just enjoy building things. Interesting ideas
                    we can get our teeth stuck into and equally quick fun
                    projects that are live before you know it.
                  </li>

                  <li className="text-gray-400 mb-4">
                    For frontend we build using modern HTML, CSS, Javascript and
                    SVG. We use React for client-side applications, and a
                  ...
                  <li className="text-gray-400 mb-4">
                    In the past, we've built with PHP, MySQL, a number of NoSQL
                    databases, Solr, Lucene, Memcached as well as countless APIs
                    and services for external data. We enjoy adapting to the
                    best tool for the job, whatever that might be.
                  </li>

                  <li className="text-gray-400 mb-4">
                    We generally use open source software. For hosting we prefer
                    using Amazon Web Services (AWS) with Linux as operating
                    system.
                  </li>
                </ul>
              </div>
              ...
              <div className="mt-4 lg:order-2 order-1">
                <div className="flex justify-center">
                  <p className="w-24 h-24 rounded-full border-2 border-[#ee6557] hover:bg-[#ee6557] flex justify-center items-center">
                    <DevelopmentIcons className="w-14 h-14 hover:fill-white" />{" "}
                  </p>
                </div>
              </div>
            </div>
