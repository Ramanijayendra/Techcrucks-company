      ...
      <div className="container">
        <section>
          <div className="text-center p-6 py-16 m-auto lg:w-1/2">
            <h1 className="text-6xl mb-10  font-bold">Terms of use</h1>
          </div>
            ...
            <div className="w-11/12">
              <section>
                <p className="text-gray-400">
                  ...
                  website
                  <Link href=""> https://www.hello@techcrucks.com</Link> (our
                  site), whether as a guest or a registered user. Please read
                  these terms of use carefully before you start to use the site.
                  By using our site, you indicate that you accept these terms of
                  use and that you agree to abide by them. If you do not agree
                  to these terms of use, please refrain from using our site.
                </p>
                <h1 className="py-3 text-gray-600">
                ...
                <p className="text-gray-400">
                  ...
                  accurate. GDPR compliance means that any data we have on you
                  continues to be stored securely and that, at your request, it
                  can be deleted. To find out what personal, or device specific,
                  data we hold, or to request that held data is deleted, you can
                  contact us at
                  <Link href=""> https://www.hello@techcrucks.com</Link> Know
                  that your data is in safe hands with us, but should any breach
                  occur, you’ll be notified as soon as possible.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-gray-400">
                  ...
                  VAT number is 899 6307 54.
                </p>
                <p className="text-gray-400">We are a limited company.</p>
                <h1 className="py-3 text-gray-600">ACCESSING OUR SITE</h1>
              ...
              <section>
                ...
                <p className="mb-4 text-gray-400">
                  ...
                  visitor to our site, or by anyone who may be informed of any
                  of its contents.
                </p>
                <h1 className="py-3 text-gray-600">
                ...
                <p className="text-gray-400">
                  ...
                  to our site, or close it indefinitely. Any of the material on
                  our site may be out of date at any given time, and we are
                  under no obligation to update such material.
                </p>
              </section>

              <section>
                <h1 className="py-3 text-gray-600">OUR LIABILITY</h1>
                <p className="mb-4 text-gray-400">
                  The material displayed on our site is provided without any
                  guarantees, conditions or warranties as to its accuracy. To
                  the extent permitted by law, both we and third parties
                ...
                <p className="mb-4 text-gray-400">loss of income or revenue;</p>
                <p className="mb-4 text-gray-400">loss of business;</p>
                <p className="mb-4 text-gray-400">
                ...
                <p className="mb-4 text-gray-400">loss of data;</p>
                <p className="mb-4 text-gray-400">loss of goodwill;</p>
                <p className="mb-4 text-gray-400">
                ...
                <p className="mb-4 text-gray-400">
                  ...
                  condition shall not prevent claims for loss of or damage to
                  your tangible property or any other claims for direct
                  financial loss that are not excluded by any of the categories
                  set out above.
                </p>
                <p className="mb-4 text-gray-400">
              ...
              <section>
                ...
                <p className="mb-4 text-gray-400">
                  From time to time we may add features to our site which allows
                  you to upload material to our site, or to make contact with
                  other users of our site.
                </p>
                <p className="mb-4 text-gray-400">
                  Whenever you make use of these features you must comply with
                  the content standards set out in our acceptable use policy.
                  You warrant that any such contribution does comply with those
                  standards, and you indemnify us for any breach of that
                  warranty.
                </p>
                <p className="mb-4 text-gray-400">
                  ...
                  material for any purpose. We also have the right to disclose
                  your identity to any third party who is claiming that any
                  material posted or uploaded by you to our site constitutes a
              ...
              <section>
                <h1 className="py-3 text-gray-600">LINKING TO OUR SITE</h1>
                <p className="mb-4 text-gray-400">
                ...
                <p className="mb-4 text-gray-400">
                  ...
                  <Link href=""> https://www.hello@techcrucks.com</Link>
                </p>
              </section>

              <section>
                <h1 className="py-3 text-gray-600">LINKS FROM OUR SITE</h1>
                <p className="mb-4 text-gray-400">
                ...
                <p className="mb-4 text-gray-400">
                  The English courts will have non-exclusive jurisdiction over
                ...
                <h1 className="py-3 text-gray-600">VARIATIONS</h1>
              ...
              <section>
                <h1 className="text-gray-600 py-3">
                  PROPOSAL PLANNER AND PITCHES
                </h1>
                <p className="text-gray-400 mb-4">
                  We aim to respond to most proposals within 24 hours, all are
                  replied to within 7 days.
                </p>
                <p className="text-gray-400 mb-4">
                  The information you submit (name, email address, phone number,
                  project outline, budget and timescale) to the proposal
                  planner, or pitched via email to{" "}
                  <Link href=""> https://www.hello@techcrucks.com</Link>, will
                  be stored securely, and removed from our system after 3 months
                  if the proposal is unsuccessful or if you decide not to
                  proceed further with the project.
                </p>
                <p className="text-gray-400 mb-4">
                  Clients should be aware that their data (including but not
                  limited to: names, phone numbers, email addresses) needs to be
                  held indefinitely to allow for ongoing communication, without
                  which maintenance and continued support would not be possible.
                </p>
                <p className="text-gray-400 mb-4">
                  All submitted data will be stored securely, in the unlikely
                  occurrence of a data breach - clients will be informed as soon
                  as possible.
                </p>
                <p className="text-gray-400 mb-4">
                  Potential, previous and present clients can email
                  <Link href=""> https://www.hello@techcrucks.com</Link> to find
                  out what information is held on them, or to ask for it to be
                  removed.
                </p>
              </section>

              <section>
                <h1 className="text-gray-600 py-3">YOUR CONCERNS</h1>
                <p className="text-gray-400 mb-4">
                ...
                <h1 className="text-gray-600 py-3">PRIVACY POLICY</h1>
                <p className="text-gray-400 mb-4">
                  Built By Buffalo Limited (“We”) are committed to protecting
                ...
                <p className="text-gray-400 mb-4">
                  For the purpose of the Data Protection Act 1998 (the Act), and
                  General Data Protection Regulation (GDPR) (EU), the data
                  controller is Daniel Griffiths of Built By Buffalo, Nile
                  House, Nile Street, Brighton BN1 1HW, United Kingdom.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-gray-400 mb-4">
                  ...
                  access. Information gathered by the use of cookies, or from
                  your IP address is not personally identifiable.
                </p>
                <p className="text-gray-400 mb-4">
                  For further clarification on the information we collect from
                  you, or to request for this information to be deleted you can
                  contact us at gdpr@builtbybuffalo.com
                </p>
              </section>

              <section>
                <h1 className="text-gray-600 py-3">IP ADDRESSES</h1>
                <p className="mb-4 text-gray-400">
                  ...
                  identify any individual. If you would like to know more about
                  what data we hold on your IP address, or to ask for this data
                  to be deleted, email gdpr@builtbybuffalo.com.
                </p>
                <h1 className="py-3 text-gray-600">COOKIES</h1>
                <p className="text-gray-400 mb-4">
                  You are only personally identifiable once you choose to give
                  us your data - either by newsletter signup, email, or by
                  completing the project planner.
                </p>
                <p className="text-gray-400 mb-4">
                  However our website uses cookies to distinguish each device
                  accessing the site from that of other users of our website.
                  This helps us to provide you with a good experience when you
                  browse our website and also allows us to improve our site.
                </p>
                <p className="text-gray-400 mb-4">
                  You will need to choose to accept or reject cookies from us
                  the first time you visit our site, and periodically you will
                  be asked to confirm your decision. For further information, to
                  change your cookie setting, or to reject and remove cookies
                  contact us at gdpr@builtbybuffalo.com - please be aware that
                  choosing to reject or remove cookies may impact on the
                  functionality of the website and, as such. your user
                  experience.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-gray-400">
                  ...
                  the EEA who work for us or for one of our suppliers. By
                  ...
                  accordance with this privacy policy and with GDPR.
                </p>
                <p className="text-gray-400">
                  All information you provide to us is stored on our secure
                  servers. Where we have given you (or where you have chosen) a
                  password which enables you to access certain parts of our
              ...
              <section>
                ...
                <p className="text-gray-400 mb-4">
                  ...
                  have consented to be contacted for such purposes (such as a
                  newsletter)
                </p>
                <p className="text-gray-400 mb-4">
              ...
              <section>
                ...
                <p className="text-gray-400 mb-4">
                  We may only disclose your personal information to third
                  parties:
                </p>
                <p className="text-gray-400 mb-4">
                ...
                <p className="text-gray-400 mb-4">
                  If Built By Buffalo Limited or substantially all of its assets
                  are acquired by a third party, in which case personal data
                ...
                <p className="text-gray-400 mb-4">
                  ...
                  protect the rights, property, or safety of Built By Buffalo
              ...
              <section>
                <h1 className="text-gray-600 py-3">YOUR RIGHTS</h1>
                <p className="text-gray-400 mb-4">
                  Your data will only be used as outlined above (see USES MADE
                  OF THE INFORMATION) however, you have the right to withdraw
                  your consent for any or all of these uses at any time, contact
                  us at
                  <Link href=""> https://www.hello@techcrucks.com</Link>.
                </p>
                <p className="text-gray-400 mb-4">
                ...
                <h1 className="text-gray-600 py-3">ACCESS TO INFORMATION</h1>
                <p className="text-gray-400 mb-4">
                  The Act, and GDPR, gives you the right to access information
                  held about you. Your right of access can be exercised in
                  accordance with this - contact us at
                  <Link href=""> https://www.hello@techcrucks.com</Link>
                </p>
              </section>
              ...
              <section>
                ...
                <h1 className="text-gray-600 py-3">ACCEPTABLE USE POLICY</h1>
                <p className="text-gray-400">
                  This acceptable use policy sets out the terms between you and
                  us under which you may access our website
                  <Link href=""> https://www.hello@techcrucks.com</Link>
                  (our site). This acceptable use policy applies to all users
                  of, and visitors to, our site.
                </p>
                <p className="text-gray-400">
                ...
                <p className="text-gray-400">
                  <Link href=""> https://www.hello@techcrucks.com</Link>is a
                  site operated by Built By Buffalo Limited (we or us). We are
                  registered in England and Wales under company number 06048231
                  and we have our registered office at The Old Casino, 28 Fourth
                  Avenue, Hove, East Sussex, BN3 2PJ. Our main trading address
                  is Built By Buffalo, Nile House, Nile Street, Brighton BN1
                  1HW, United Kingdom. Our VAT number is 899 6307 54
                </p>
              </section>

              <section>
                <h1 className="text-gray-600 py-3">PROHIBITED USES</h1>
                <p className="text-gray-400 mb-4">
                ...
                <p className="text-gray-400 mb-4">
                  ...
                  form of similar solicitation (spam); or to knowingly transmit
                  any data, send or upload any material that contains viruses,
                ...
                <p className="text-gray-400 mb-4">You also agree:</p>
                <p className="text-gray-400 mb-4">
                ...
                <p className="text-gray-400 mb-4">any part of our site;</p>
                <p className="text-gray-400 mb-4">
              ...
              <section>
                <h1 className="text-gray-600 py-3">INTERACTIVE SERVICES</h1>
                <p className="text-gray-400">
                  We may from time to time provide interactive services on our
                  site (interactive services).
                </p>
                <p className="text-gray-400">
              ...
              <section>
                <h1 className="text-gray-600 py-3">CONTENT STANDARDS</h1>
                <p className="text-gray-400 mb-4">
                ...
                <p className="text-gray-400 mb-4">Contributions must:</p>
                <p className="text-gray-400 mb-4">
                ...
                <p className="text-gray-400 mb-4">Contributions must not:</p>
                <p className="text-gray-400 mb-4">
                ...
                <p className="text-gray-400 mb-4">promote violence;</p>
                <p className="text-gray-400 mb-4">
              ...
              <section>
                ...
                <p className="text-gray-400 mb-4">
                  ...
                  a material breach of the terms of use upon which you are
                ...
                <p className="text-gray-400 mb-4">issue of a warning to you;</p>
                <p className="text-gray-400 mb-4">
