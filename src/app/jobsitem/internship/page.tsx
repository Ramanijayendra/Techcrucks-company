        ...
        <div className="flex justify-center p-4 ">
          <div className="shadow-md lg:w-1/2 p-4  bg-white text-center py-6">
            <p className="text-[16px] text-gray-500">
              ...
              interns. We will reopen internships when we return to the office.
          ...
          <div className="lg:w-1/2 ">
            <ul>
              <li className="mt-8">
                ...
                projects online that show your skills and be someone we can rely
                on for the duration of the placement.
              </li>
              <li className="mt-7">
                We want people who are independent, enjoy exploring a new
                location and like a bit of fun mixed in with their working day.
                We do ask for potential applicants to be well skilled but we
                will give you a lot in return if you have the talent.
              </li>
              <li className="mt-7">
          ...
          <div className="lg:w-7/12 ">
            ...
            <div className="flex justify-center flex-col lg:gap-6 lg:flex-row">
              ...
              <div className="lg:w-6/12 w-72 ">
                <div className="flex flex-row  gap-3 mb-2">
                  <p className="w-2 h-2 rounded-full bg-[#e15339] mt-2"></p>
                  <p className="text-gray-400">Understanding of grid systems</p>
                </div>
                <div className="flex flex-row  gap-3 mb-2">
                  <p className="w-2 h-2 rounded-full bg-[#e15339] mt-2"></p>
                  <p className="text-gray-400">
