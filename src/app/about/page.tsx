      ...
      <div className="container">
        <div className="text-center p-6 py-16 m-auto lg:w-7/12">
          ...
          <p className="text-2xl text-gray-400 font-normal text-[19px] ">
            {" "}
            Founded in 2006, techcrucks is a small web design & development agency
            based in indian. Over the last few years we've made a
        ...
        <div className="flex gap-7 flex-col mb-5 justify-center items-center lg:flex-row  lg:mt-[-55px]">
          <div className="hexagonhome-container lg:relative lg:w-[230px] lg:h-[240px] lg:border-2 border-[#eee2e2] bg-[#fcfbfb]">
            <Image
              src={placeimg}
              className="hexagonhome-image w-[100%] h-[100%] lg:absolute lg:w-[100%] lg:h-[100%] lg:text-center lg:bg-[white] "
              alt="homeimages"
            />
          </div>
          <div className="hexagonhome-container lg:relative lg:w-[230px] lg:h-[240px] lg:border-2 border-[#eee2e2] bg-[#fcfbfb]">
